...
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Procesos</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- @can('create-process') --}}
                            <a href="{{ route('processes.create') }}" class="btn btn-warning mb-3">Registrar proceso nuevo</a>
                            {{-- @endcan --}}
                                ...
                                <tbody>
                                    @foreach ($processes as $process)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- @can('edit-process') --}}
                                                    <a href="{{ route('processes.edit', $process->id) }}" class="btn btn-warning">Editar</a>
                                                {{-- @endcan --}}
                                                {{-- @can('delete-process') --}}
                                                    {!! Form::open(['method' => 'DELETE', 'route' =>['processes.destroy', $process->id], 'style' =>'display:inline', 'class' => 'delete',]) !!}

...
@section('content')
@section('title', 'Número de parte')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Números de parte</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {{-- @can('create-part') --}}
                            <a href="{{ route('parts.create') }}" class="btn btn-warning mb-3">Registrar número de parte nuevo</a>
                            {{-- @endcan --}}
                                ...
                                <tbody>
                                    @foreach ($parts as $part)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- @can('edit-part') --}}
                                                    <a href="{{ route('parts.edit', $part->id) }}" class="btn btn-warning">Editar</a>
                                                {{-- @endcan --}}
                                                {{-- @can('delete-part') --}}
                                                    {!! Form::open(['method' => 'DELETE', 'route' =>['parts.destroy', $part->id], 'style' =>'display:inline', 'class' => 'delete',]) !!}
...
@section('page_js')
    ...
    @if (session('del') == 'ok')
        <script>
            Swal.fire(
                'Eliminado!',
                'EL número de parte ha sido eliminado.',
                'success'
            )
        </script>
    @endif
